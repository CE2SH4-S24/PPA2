...
// Watch Briefing/Supporting Videos and read the PPA2 Manual before starting on the activity!



// PREPROCESSOR CONSTANT DEFINITIONS HERE
/////////////////////////////////////////
...
// [TODO] : Define objPos structure here as described in the PPA2 document

// [TODO] : Define the Direction enumeration here as described in the PPA2 document
//          This will be the key ingredient to construct a simple Finite State Machine
//          For our console game backbone.



// FUNCTION PROTOTYPING DEFINITIONS HERE
/////////////////////////////////////////
...
// 
// As a good practice, always insert prototypes before main() and implementations after main()
...
void Initialize(void)
{
    ...
    // [TODO] : Initialize more variables here as needed.
...
void DrawScreen(void)
{
    // [TODO] : Implement the latest drawing logic as described in the PPA2 manual
    //
    ...
    //          If on border of the game board, print a special border character
    ...
    //     same layout as presented in the PPA2 manual
